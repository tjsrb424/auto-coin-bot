...
def discovery_scheduler_config() -> dict:
    ...
    return {
        ...
        "scan_interval_minutes": _minutes_env("AUTO_MARKET_SCAN_INTERVAL_MINUTES", 60, minimum=5),
        ...
        "fast_interval_minutes": _minutes_env("AUTO_FAST_VALIDATION_INTERVAL_MINUTES", 180, minimum=15),
        ...
        "max_auto_save_candidates_per_run": _int_env("AUTO_VALIDATION_MAX_SAVE_PER_RUN", 5, minimum=0, maximum=20),
        "max_auto_save_candidates_per_day": _int_env("AUTO_VALIDATION_MAX_SAVE_PER_DAY", 10, minimum=1, maximum=100),
        "max_backtest_passed_candidates": _int_env("AUTO_VALIDATION_MAX_BACKTEST_PASSED", 30, minimum=1),
        "promotion_enabled": _bool_env("AUTO_PROMOTION_PIPELINE_ENABLED", True),
        "promotion_interval_minutes": _minutes_env("AUTO_PROMOTION_INTERVAL_MINUTES", 15, minimum=1),
